...
raw_data <- read.csv("D:/Writer/DNA/A4K.705- Sampling and Observational Data - 1400w - 26.09 @22.00/starter_folder-main/data/raw_data/transport_bus_initiative.csv")
...
write.csv(cleaned_data, "D:/Writer/DNA/A4K.705- Sampling and Observational Data - 1400w - 26.09 @22.00/starter_folder-main/data/analysis_data/cleaned_transport_bus_data.csv", row.names = FALSE)
